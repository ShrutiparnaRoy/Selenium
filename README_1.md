...
4. Browser Automation Script: Developed script to launch browser, navigate to test URL, capture page title and current URL, and safely close browser
5. Driver Discovery: Demonstrated automatic driver download on first run and cache utilization on subsequent runs
